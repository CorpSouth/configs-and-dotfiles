...
static const char black[]          = "#2E3436";
static const char bright_black[]   = "#555753";
static const char white[]          = "#D3D7CF";
static const char bright_white[]   = "#EEEEEC";
static const char cyan[]           = "#06989A";
static const char *colors[][3]     = {
	/*               fg     bg     border       */
	[SchemeNorm] = { white,        black, bright_black },
	[SchemeSel]  = { bright_white, cyan,  cyan  },
};
...
static const char *dmenucmd[]        = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", black, "-nf", white, "-sb", cyan, "-sf", bright_white, NULL };
...
static const char *voldowncmd[]      = { "pamixer.sh", "down", NULL };
static const char *volmutecmd[]      = { "pamixer.sh", "mute", NULL };
static const char *volupcmd[]        = { "pamixer.sh", "up", NULL };
