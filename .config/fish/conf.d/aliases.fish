...
alias cleanall 'rpm-ostree cleanup -bmpr'
alias cleanbase 'rpm-ostree cleanup -b'
alias cleanmd 'rpm-ostree cleanup -m'
alias cleanpend 'rpm-ostree cleanup -p'
alias cleanrb 'rpm-ostree cleanup -r'
...
########################
#Shell History Sweeping#
########################

alias purge 'clear && builtin history clear'
