...
if (get_window_class() == "betterbird") then         
...
if (get_window_class() == "librewolf-default") then                   
 set_window_workspace(1);
end
...
if (get_window_class() == "ArmCord") then
...
if (get_window_class() == "ONLYOFFICE Desktop Editors") then
 set_window_workspace(4);
end
...
if (get_window_class() == "BleachBit") then                   
...
if (get_window_class() == "CMST - Connman System Tray") then                   
 set_window_workspace(5);
end
...
if (get_window_class() == "Mugshot") then
 set_window_workspace(5);
end
...
if (get_window_class() == "Nsxiv") then
 set_window_workspace(5);
end
...
if (get_window_class() == "Xfce4-clipman-settings") then
 set_window_workspace(5);
end
...
if (get_window_class() == "Xfce4-panel-profiles.py") then    
 set_window_workspace(5);
end    
...
if (get_window_class() == "Xfce4-sensors") then
 set_window_workspace(5);
end
...
if (get_window_class() == "Remote-viewer") then                 
 set_window_workspace(6);
end

if (get_window_class() == "Virt-manager") then                 
 set_window_workspace(6);
end
